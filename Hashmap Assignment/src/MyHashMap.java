...
/**
 * MyHashMap - Implementation of a hashmap.
 * @author - Dr. Johnson
...
public class MyHashMap implements MyMap {
  ...
  public java.util.Set<MyMap.Entry> entrySet() {
    java.util.Set<MyMap.Entry> set = 
      new java.util.HashSet<MyMap.Entry>();
  ...
  public Person put(String key, Person value) {
    if (get(key) != null) { // The key is already in the map
      ...
      for (Entry entry: bucket)
        if (entry.getKey().equals(key)) {
          Person oldValue = (Person) entry.getValue();
    ...
    if (table[bucketIndex] == null) {
      table[bucketIndex] = new LinkedList<Entry>();
    }
  ...
  public java.util.Set<Person> values() {
    java.util.Set<Person> set = new java.util.HashSet<Person>();
  ...
  /** Rehash the map */
  private void rehash() {
    java.util.Set<Entry> set = entrySet(); // Get entries
  ...
  @Override //Builds the string output of an entry in the map.

...
{
    // first get each linked list in the array
    for (Node current: other.elementData)
    {
        Node listElement = current;
        // now get each element in the linked list and add value to this HashSet
        while (listElement != null)
        {
            this.add(listElement.data);
 ...
 {
   HashIntSet original = new HashIntSet();
   original.add(1);
   original.add(2);
   original.add(3);
   HashIntSet other = new HashIntSet();
   other.add(10);
   other.add(1);
   other.add(8);
   other.add(9);
